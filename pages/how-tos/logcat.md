...
{% include alerts/note.html content="This method requires that your device is [rooted](https://download.conqueros.co/extras), which is only officially supported up through ConquerOS 16.0, users of 17.1 or above will need to use a computer." %}
